 ...
 * This is intentionally narrow: it only runs when Android Advanced Protection is enabled, the Accessibility runtime is unavailable, LoqIn protection is enabled and Usage Access is granted.
