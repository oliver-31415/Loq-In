...
package com.oliver.loqin.platform.receiver.wifi
...
class WifiTriggerService : Service() {
    ...
    private fun scheduleWifiRetryIfNeeded(reason: String) {
        val hasWifiSchedules = com.oliver.loqin.data.prefs.ScheduleStore
    ...
    companion object {
        ...
        private const val NOTIF_CHANNEL_ID = "loqin_wifi_triggers_silent"
