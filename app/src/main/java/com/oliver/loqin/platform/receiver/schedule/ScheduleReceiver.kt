...
package com.oliver.loqin.platform.receiver.schedule
...
class ScheduleReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // If the user manually toggled LoqIn while a RANGE schedule is active, don't let the schedule instantly override the user's choice.
    ...
    companion object {
        const val ACTION_TICK = "com.oliver.loqin.schedule.TICK"
        private const val TAG = "ScheduleReceiver"
        private const val PREFS_WIFI = "loqin_wifi_cache"
        ...
        private const val PREFS_BT = "loqin_bt_cache"
