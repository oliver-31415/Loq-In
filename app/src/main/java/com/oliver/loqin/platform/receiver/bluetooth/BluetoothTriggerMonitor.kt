...
import com.oliver.loqin.platform.receiver.logic.BluetoothTriggerReceiverLogic
import com.oliver.loqin.ui.MainActivity
import java.util.concurrent.Executors

object BluetoothTriggerMonitor {

    private const val PREFS = "loqin_prefs_schedules"
    ...
    private val syncExecutor = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "LoqInBluetoothMonitor").apply { isDaemon = true }
    }
    ...
    private const val FALLBACK_CHANNEL_ID = "loqin_fallback_bt_silent"
