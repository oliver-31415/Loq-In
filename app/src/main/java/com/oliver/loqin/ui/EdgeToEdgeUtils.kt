 ...
 * LoqIn's UI is mostly "classic" (Toolbar + content below).
...
object EdgeToEdgeUtils {
    ...
    fun setupClassic(
        ...
        // Do not try to opt back out with decorFitsSystemWindows=true; use the compatibility helper and apply the system-bar insets required by LoqIn's classic XML screens explicitly.
