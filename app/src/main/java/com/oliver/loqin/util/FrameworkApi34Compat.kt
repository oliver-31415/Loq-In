...
object FrameworkApi34Compat {
    private const val TAG = "LoqInApi34Compat"
     ...
     * On those devices LoqIn keeps Android 14's normal decor-fitting behavior instead of installing AndroidX edge-to-edge/insets listeners.
     */
    ...
    fun applyThemeWorkaround(activity: Activity) {
        ...
        activity.theme.applyStyle(R.style.LoqInApi34FrameworkCompatOverlay, true)
