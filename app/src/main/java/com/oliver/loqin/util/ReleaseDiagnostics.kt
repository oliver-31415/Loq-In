...
object ReleaseDiagnostics {
    ...
    fun snapshot(context: Context): Snapshot {
        ...
        val status = when {
            ...
            !BuildConfig.LOQIN_RELEASE_SIGNING_CONFIGURED -> Status.WARNING
        ...
        val signingMessage = when (status) {
            ...
            Status.WARNING -> "This build was produced without Loq In's configured official release signing inputs."
