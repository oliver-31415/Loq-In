...
object AppSigningInfo {
     ...
     * PackageInfoCompat handles the pre-Android-9 compatibility path without direct use of the deprecated PackageInfo.signatures/GET_SIGNATURES APIs in LoqIn code.
     */
