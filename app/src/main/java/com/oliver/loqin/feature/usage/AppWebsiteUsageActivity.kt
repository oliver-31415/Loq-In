...
import com.oliver.loqin.blocking.LoqInAccessibilityService
...
import com.oliver.loqin.databinding.ActivityStatisticsAppWebsiteUsageBinding
import com.oliver.loqin.feature.settings.AccessibilityDisclosure
...
class AppWebsiteUsageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b.webPlaceholder.background = GradientDrawable().apply {
            ...
            setColor(ContextCompat.getColor(this@AppWebsiteUsageActivity, R.color.loqin_card_bg))
            setStroke(dp(1), ContextCompat.getColor(this@AppWebsiteUsageActivity, R.color.loqin_card_stroke))
    ...
    private fun applyAccentUi() {
        ...
        b.cardUsageTotal.setCardBackgroundColor(ContextCompat.getColor(this, R.color.loqin_card_bg))
        b.cardUsageTotal.strokeColor = ContextCompat.getColor(this, R.color.loqin_card_stroke)
    ...
    private fun buildRefreshData(range: Range, isWeb: Boolean): RefreshData {
        val hasA11y = PermissionUtils.isAccessibilityServiceEnabled(this, LoqInAccessibilityService::class.java)
    ...
    private fun maybeShowDeviceFallbackDialog(range: Range) {
        ...
        MaterialAlertDialogBuilder(this)
            .setTitle(R.string.usage_loqin_fallback_title)
            .setMessage(R.string.usage_loqin_fallback_message)
            .setPositiveButton(if (hasUsageAccess) R.string.usage_loqin_fallback_positive else R.string.onb_open) { _, _ ->
                if (hasUsageAccess) {
    ...
    private fun showSortFilterMenu(anchor: View) {
        ...
        filterDropdown.setAdapter(LoqInDropdownAdapter(this, filterOptions.map { it.second }))
