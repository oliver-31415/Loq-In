...
import com.oliver.loqin.data.onboarding.OnboardingPage
...
import com.oliver.loqin.feature.support.SupportActivity
import com.oliver.loqin.feature.usage.IgnoredUsageAppsActivity
...
class OnboardingActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext.setOnClickListener {
            ...
            // Keep the core requirement intact if apps were removed there before the user starts LoqIn.
    ...
    // in that specific case Usage Access is enough to continue with LoqIn's clearly-labelled limited whole-app fallback.
    ...
    private fun openFirstMissingPermissionSetting() {
        when {
            ...
            !PermissionUtils.isAccessibilityServiceEnabled(this, LoqInAccessibilityService::class.java) &&
    ...
    private fun permissionOverviewDescription(ctx: Context): String {
        ...
        return getString(
            if (AdvancedProtectionCompat.isEnabled(ctx) &&
                !PermissionUtils.isAccessibilityServiceEnabled(ctx, LoqInAccessibilityService::class.java)) {
