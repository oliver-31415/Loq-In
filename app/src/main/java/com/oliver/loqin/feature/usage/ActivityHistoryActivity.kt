...
class ActivityHistoryActivity : AppCompatActivity() {
    ...
    private fun showSortFilterDialog() {
        ...
        typeDropdown.setAdapter(LoqInDropdownAdapter(this, typeLabels))
    ...
    private fun MaterialCardView.applyLoqInCardColors() {
