...
package com.oliver.loqin.feature.blocker
...
class BlockerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // (Only affects LoqIn screens - Android does not allow changing previews of other apps.)
        runCatching {
    ...
    private fun flushDelta() {
        // "Blocked time" stats should reflect how long an app was configured as blocked while LoqIn was enabled (independent of this UI being visible).
    ...
    private fun showBlockReasonInfo() {
        ...
        fun row(labelRes: Int, value: String, emphasized: Boolean = false): LoqInInfoRow? {
            if (value.isBlank()) return null
            return LoqInInfoRow(getString(labelRes), value, emphasized)
        }
