...
package com.oliver.loqin.feature.onboarding.adapters
...
import com.oliver.loqin.feature.onboarding.OnboardingUsagePreviewRenderer
    ...
    class StandardVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun renderDetails(activity: Activity, page: OnboardingPage, accent: Int) {
            ...
            if (page.type == OnboardingPage.Type.PERMISSION_OVERVIEW) {
                ...
                addPermissionRow(
                    ...
                    checked = PermissionUtils.isAccessibilityServiceEnabled(activity, LoqInAccessibilityService::class.java),
                    required = true,
                    accent = accent,
        ...
        private fun addReviewAppsSummaryCard(
            ...
            val card = MaterialCardView(activity).apply {
                ...
                isFocusable = true
                setOnClickListener {
                    (activity as? com.oliver.loqin.feature.onboarding.OnboardingActivity)
