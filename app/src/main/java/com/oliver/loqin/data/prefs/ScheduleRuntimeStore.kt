 ...
 * - tracks whether LoqIn was enabled by a schedule (used for disable-on-exit)
 * - tracks whether LoqIn was disabled by a schedule (used for enable-on-exit)
...
object ScheduleRuntimeStore {
    ...
    private const val PREFS = "loqin_schedule_runtime"
