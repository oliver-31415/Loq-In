...
// Persists and retrieves schedule execution count state.
object ScheduleExecutionCountStore {
    private const val PREFS = "loqin_prefs"
    private const val PREFIX = "schedule_exec_count_" // schedule_exec_count_yyyymmdd
