...
object ProfileStore {
    ...
    private fun getRawBlockedForProfile(context: Context, profile: String): Set<String> {
        ...
        // Keep the stored set mostly intact (minus blanks), but always exclude packages that LoqIn currently protects for device safety (for example the active launcher or keyboard).
        return raw
