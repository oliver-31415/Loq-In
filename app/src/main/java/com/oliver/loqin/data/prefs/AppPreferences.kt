...
/**
 * Most of LoqIn's existing stores are still SharedPreferences-based (and that's totally OK).
 * This DataStore is meant for *lightweight* flags that shouldn't be scattered across activities.
 */
private val Context.appPreferencesDataStore by preferencesDataStore(name = "loqin_datastore")
