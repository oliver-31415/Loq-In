...
/**
 * Tracks how long LoqIn's watcher/service was running.
 * We keep a "currently running since" timestamp, and a per-day accumulated runtime.
 */
object LoqInRuntimeStore {
    private const val PREFS = "loqin_prefs"

    private const val KEY_RUNNING_SINCE = "loqin_runtime_running_since"
    private const val PREFIX_DAY = "loqin_runtime_ms_" // loqin_runtime_ms_yyyymmdd
