...
| 2026-09-21 | **W5.2 limit fix 3** | `feature/upstream-w6-polish` | Done — `f8f22d5` | Owner still hit the website refusal: the clock button in the Websites list opened the (locked) rule editor. It now opens the gated limit editor; the row tap still opens the rule editor |
